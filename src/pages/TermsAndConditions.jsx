...
const TermsAndConditions = () => {
  const bulletStyle = { marginBottom: '12px', lineHeight: '1.8' }
      ...
      <main style={{ backgroundColor: COLORS.dark, padding: '120px 0 64px' }}>
        <div style={{ maxWidth: '896px', margin: '0 auto', padding: '0 24px' }}>
          <h1 style={{
            ...
            Terms & <span style={{ color: COLORS.accent }}>Conditions</span>
          </h1>
          ...
          <div style={{ color: COLORS.textMuted, lineHeight: '1.8' }}>
            <ul style={{ listStyle: 'disc', paddingLeft: '24px' }}>
              ...
              <li style={bulletStyle}>
                This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://hoh108.com/" style={{ color: COLORS.accent }}>https://hoh108.com/</a> application.
              </li>
              <li style={bulletStyle}>
                The Platform is owned by <strong style={{ color: COLORS.textLight }}>HANCET GLOBE PRIVATE LIMITED</strong>, a company incorporated under the Companies Act, 1956 with its registered NO 414, Vasantharaj building, Bellur, Mandya, 571418.
              </li>
              <li style={bulletStyle}>
                Your use of the Platform and services and tools are governed by the following terms and conditions as applicable to the Platform including the applicable policies which are incorporated herein by way of reference. If You transact on the Platform, You shall be subject to the policies that are applicable to the Platform for such transaction. By mere use of the Platform, You shall be contracting with the Platform Owner and these terms and conditions including the policies constitute Your binding obligations, with Platform Owner. These Terms of Use relate to your use of our website, goods or services. Any terms and conditions proposed by You which are in addition to or which conflict with these Terms of Use are expressly rejected by the Platform Owner and shall be of no force or effect. These Terms of Use can be modified at any time without assigning any reason. It is your responsibility to periodically review these Terms of Use to stay informed of updates.
              </li>
              <li style={bulletStyle}>
              ...
              <li style={bulletStyle}>
                <strong style={{ color: COLORS.textLight }}>ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</strong>
              </li>
              <li style={bulletStyle}>
              ...
              <li style={bulletStyle}>
                All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Karnataka.
              </li>
              <li style={bulletStyle}>
