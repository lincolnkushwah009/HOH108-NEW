...
const Login = () => {
  ...
  // Clear any expired tokens when landing on login page
  useEffect(() => {
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '460px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          <h1 style={{ fontSize: '40px', fontWeight: '700', color: '#FFFFFF', marginBottom: '12px' }}>HOH108</h1>
          <p style={{ fontSize: '18px', color: 'rgba(221, 197, 176, 0.9)' }}>Enterprise Resource Planning</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{
              ...
              <label style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }}>
                <input
                  type="checkbox"
                  style={{ width: '20px', height: '20px', accentColor: '#C59C82', borderRadius: '6px' }}
                />
                <span style={{ fontSize: '15px', color: '#475569' }}>Remember me</span>
              </label>
              <a href="#" style={{ fontSize: '15px', color: '#C59C82', fontWeight: '600', textDecoration: 'none' }}>
                Forgot password?
              </a>
            </div>
            ...
            <button
              ...
              onMouseOver={(e) => !loading && (e.target.style.background = '#A68B6A')}
              onMouseOut={(e) => !loading && (e.target.style.background = '#C59C82')}
            >
              {loading ? (
                <>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '15px', color: '#64748b', margin: 0 }}>
              Need help?{' '}
              <a href="mailto:support@hoh108.com" style={{ color: '#C59C82', fontWeight: '600', textDecoration: 'none' }}>
                Contact Support
              </a>
            </p>
          </div>
        ...
        {/* Footer */}
        <p style={{ textAlign: 'center', color: 'rgba(221, 197, 176, 0.7)', fontSize: '14px', marginTop: '40px' }}>
